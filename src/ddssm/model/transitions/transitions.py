...
from ddssm.nn.gaussians import GaussianStats, gaussian_entropy, gaussian_kl_divergence
from ddssm.model.encoder import GaussianHead, ContextProducer
...
class GaussianTransition(BaseTransition):
    ...
    :class:`~ddssm.nn.diffnets.ContextProducer` (no mask features), and mapped to
    ``(μ, log σ²)`` by a :class:`~ddssm.model.encoder.GaussianHead`.
    """
