...
M1_N: int = 4
M1_D: int = 2
M1_ESM_CHUNK_LOSS_SCALAR: float = 3.0086047649383545
M1_ESM_CHUNK_LOSS_PER_SAMPLE: list[float] = [0.026249336078763008, 2.2026147842407227, 0.05424949899315834, 0.7254911065101624]
...
M8_FINAL_METRICS: dict = {'loss/total': 37.25070571899414, 'loss/distortion/rec': 7.655881404876709, 'loss/rate/init/tot': 0.048452239483594894, 'loss/rate/init/vhp': 0.048452239483594894, 'loss/rate/init/entropy': 0.0, 'loss/rate/trans/kl': 29.546371459960938, 'loss/rate/total': 29.594823837280273, 'calib/ratio_res2_to_sigma2': 0.4341282248497009, 'loss/rate/trans/r_sigma_p': 0.0, 'loss/rate/trans/r_mu_p': 0.0, 'loss/rate/init/kl_aux': 0.01616634801030159, 'loss/rate/init/loss_init': 0.032285891473293304, 'diag/sigma_data2/t=1': 0.9992090463638306, 'diag/sigma_data2/t=2': 1.6156190633773804, 'diag/sigma_data2/t=3': 2.7699949741363525, 'diag/sigma_data2/t=4': 5.649107933044434, 'diag/sigma_data2/t=5': 7.697213649749756, 'diag/sigma_data2/t=6': 10.517608642578125, 'diag/sigma_data2/t=7': 9.631880760192871, 'diag/sigma_data2/t=8': 9.716015815734863, 'diag/sigma_data2/t=9': 1.0, 'diag/sigma_data2/t=10': 1.0, 'diag/sigma_data2/t=11': 1.0, 'diag/sigma_data2/t=12': 1.0, 'diag/sigma_data2/t=13': 1.0, 'diag/sigma_data2/t=14': 1.0, 'diag/sigma_data2/t=15': 1.0, 'diag/sigma_data2/t=16': 1.0}
