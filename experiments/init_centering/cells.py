"""Single source of truth for the 18-cell ablation grid.
...
because they have no μ_p parameters to learn.  That removes 6 cells
(2 forms × 1 mode × 3 tracking) and yields 18 distinct triples.
"""
...
TRACKING_MODES: tuple[str, ...] = ("fixed", "global_ema", "per_t")
...
def iter_cells() -> Iterator[tuple[str, str, str]]:
    """Yield ``(baseline_form, baseline_mode, tracking_mode)`` for all 18 cells."""
