...
ProbeLGSSM = Synthetic(mode="lgssm", D=1, T=32,
                       N_per_split=256, batch_size=32)
ProbeBimodal = Synthetic(mode="bimodal", D=1, T=32,
                         N_per_split=256, batch_size=32)
ProbeBimodalNoisy = Synthetic(mode="bimodal-noisy", D=1, T=32,
                              N_per_split=256, batch_size=32)
NonlinearBimodalLift = Synthetic(
    mode="nonlinear-bimodal-lift", D=4, T=32,
    N_per_split=256, batch_size=32,
)
